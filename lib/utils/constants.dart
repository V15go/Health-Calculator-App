...
const COLOR_DARK_BLUE = Color.fromRGBO(37, 101, 174, 1.0);
const COLOR_PRIME_BLUE = Color.fromRGBO(15, 82, 152, 1.0);

const COLOR_YELLOW = Color.fromRGBO(255, 131, 3, 1.0);
const COLOR_YELLOW2 = Color.fromRGBO(254, 188, 5, 1.0);
const COLOR_BLUE_2 = Color.fromRGBO(1, 186,235, 1.0);
