import 'package:calories_counter/utils/bfp_calculator.dart';
...
class bfp_calc extends StatefulWidget {
  const bfp_calc({Key? key}) : super(key: key);

  @override
  _bfp_calcState createState() => _bfp_calcState();
}

class _bfp_calcState extends State<bfp_calc> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Center(
                child:    button(
                    ...
                    onPressed: (){
                      ...
                      ans = bfp_calculator(age:age, gender: curr_ind,height: height, weight: weight);


                      setState(() {
                        bfp = ans?.calculatebfp();
                        sol = ans?.get_process();
                    ...
                    child: Text('Calculate Body fat',style: const TextStyle(
              ...
              Container(
                  ...
                  child: Text("Your Body fat percentage is :",textAlign: TextAlign.center, style: const TextStyle(
                      fontSize: 24,
                      fontWeight: FontWeight.bold
                  ),)
              ),
              ...
              Container(
                  width: double.infinity,
                  child: Text("$bfp",textAlign: TextAlign.center, style: const TextStyle(
                      fontSize: 24,
                      fontWeight: FontWeight.bold
                  ),)
              ),
